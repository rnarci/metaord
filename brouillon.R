...
sigma = 0.5
brouillon = matrix(0,12,12)
kRNG1 = make.kRNG(jaccard_abundance, k = k, sigma = sigma)

kRNG2 = make.kRNG(ab_jaccard_abundance, k = k, sigma = sigma)

kRNG3 = make.kRNG(braycurtis_abundance, k = k, sigma = sigma)

kRNG4 = make.kRNG(ab_ochiai_abundance, k = k, sigma = sigma)

kRNG5 = make.kRNG(ab_sorensen_abundance, k = k, sigma = sigma)

kRNG6 = make.kRNG(simka_jaccard_abundance, k = k, sigma = sigma)

kRNG7 = make.kRNG(chord_prevalence, k = k, sigma = sigma)

kRNG8 = make.kRNG(jaccard_prevalence, k = k, sigma = sigma)

kRNG9 = make.kRNG(kulczynski_prevalence, k = k, sigma = sigma)

kRNG10 = make.kRNG(ochiai_prevalence, k = k, sigma = sigma)

kRNG11 = make.kRNG(whittaker_prevalence, k = k, sigma = sigma)

kRNG12 = make.kRNG(simka_jaccard_prevalence, k = k, sigma = sigma)
